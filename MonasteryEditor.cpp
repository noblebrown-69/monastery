...
MonasteryEditor::MonasteryEditor(QWidget *parent) : QWidget(parent) {
    ...
    palette.setColor(QPalette::Base, QColor(245, 235, 210));  // Warm beige parchment
    palette.setColor(QPalette::Text, QColor(50, 50, 50));     // Dark ink
    ...
    new SpellCheckHighlighter(m_textEdit->document());
